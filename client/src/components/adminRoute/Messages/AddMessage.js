          ...
          <form id="addMessage" onSubmit={onSubmit}>
               <div className="form-group">
                ...
                onChange={onChange}/>
                    ...
                    <input type="checkbox" name="path" checked={message.path===user.image} value={user.image} className="ml-2" disabled={message.path===user.image}
                  onChange={onChange}/>
                  </>
                }
                <input type="submit" disabled={ message.content === '' } className="btn btn-primary btn-block" value="Add a message"/>                                                                 
            </div>
        </form>
        </div>
        </ModalBody>
